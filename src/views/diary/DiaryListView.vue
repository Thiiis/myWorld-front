  ...
  <div class="diary-container p-4">
    ...
    <div>
      <div class="header-top">
        <div class="d-flex align-items-center text-white fw-bold px-3 py-2">
    ...
    <div class="filter-box d-flex justify-content-between align-items-center flex-wrap mb-3">
      ...
      <div class="d-flex gap-2 align-items-center">
        ...
        <button class="btn btn-primary" @click="goToCreatePage">
          <i class="bi bi-pencil-square me-1"></i>새 일기 작성
        </button>
      </div>
    </div>
...
const emit = defineEmits([
  ...
  "update:folder-type",
  "go-page",
  "go-to-create", // 💡 새 일기 작성 버튼 클릭 시 상위 컴포넌트(router-view)에 이벤트 전달
]);
    ...
    store.commit('diary/setDiaryEntries', [
      {
        id: 1,
        title: "첫 번째 일기",
        content: "오늘은 Vue.js 공부를 시작했다. 내용이 꽤 길면 두 줄까지 보여주고 말줄임표로 처리됩니다.",
        date: "2025.10.01",
        folder: "all",
        images: [],
        tags: ["일상", "공부"],
